...
@Entity
@Table(name = "komentar_dokumen")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class KomentarDokumen {
    ...
    @Column(name = "email_pengguna", length = 100)
